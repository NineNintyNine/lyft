...
class CarFactory:
        ...
        def create_calliope(current_date: datetime, last_service_date: datetime, current_mileage: int, last_service_mileage: int, sensor_array: Double)-> Car:
            ...
            car.battery = SpindleBattery(last_service_date, current_date)
            car.tire = CarriganTires(last_service_date, sensor_array)
        #   car.tire = OctoprimeTires(last_service_date, sensor_array)
            return car
        @staticmethod
        ...
        def create_palindrome(current_date: datetime, last_service_date: datetime, warning_light_on: bool, sensor_array: Double)-> Car:
            car = Car()
            car.engine = SternmanEngine(last_service_date, warning_light_on)
            car.battery = SpindleBattery(last_service_date, current_date)
            car.tire = CarriganTires(last_service_date, sensor_array)
            return car
        @staticmethod
